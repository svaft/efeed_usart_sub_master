...
void init_buttons(void){
	int num = 0;
	bt[num].clk_mode = 10;
	bt[num].GPIOx = GPIO1_GPIO_Port;// BUTTON_1_GPIO_Port;
	bt[num].button_pin = GPIO1_Pin;
	bt[num].buttons = bt[num].buttons_mask = LL_GPIO_IsInputPinSet(bt[num].GPIOx,bt[num].button_pin); //bt[0].GPIOx->IDR & bt[0].button_pin;

	num++;
	bt[num].clk_mode = 10;
	bt[num].GPIOx = GPIO2_GPIO_Port;//BUTTON_LEFT_TOP_GPIO_Port;
	bt[num].button_pin = GPIO2_Pin; //BUTTON_LEFT_TOP_Pin;
	bt[num].buttons = bt[num].buttons_mask = LL_GPIO_IsInputPinSet(bt[num].GPIOx,bt[num].button_pin); //bt[0].GPIOx->IDR & bt[0].button_pin;
	
	num++;
	bt[num].clk_mode = 10;
	bt[num].GPIOx = GPIO4_GPIO_Port;//BUTTON_RIGHT_TOP_GPIO_Port;
	bt[num].button_pin = GPIO3_Pin; //BUTTON_RIGHT_TOP_Pin;
	bt[num].buttons = bt[num].buttons_mask = LL_GPIO_IsInputPinSet(bt[num].GPIOx,bt[num].button_pin); //bt[0].GPIOx->IDR & bt[0].button_pin;

	num++; //4
	bt[num].clk_mode = 10;
	bt[num].GPIOx = GPIO4_GPIO_Port;//BUTTON_LEFT_BOTTOM_GPIO_Port;
	bt[num].button_pin = GPIO4_Pin; //BUTTON_LEFT_BOTTOM_Pin;
	bt[num].buttons = bt[num].buttons_mask = LL_GPIO_IsInputPinSet(bt[num].GPIOx,bt[num].button_pin); //bt[0].GPIOx->IDR & bt[0].button_pin;

	num++; //5
	bt[num].clk_mode = 10;
	bt[num].GPIOx = GPIO5_GPIO_Port;//BUTTON_RIGTH_BOTTOM_GPIO_Port;
	bt[num].button_pin = GPIO5_Pin; //BUTTON_RIGTH_BOTTOM_Pin;
	bt[num].buttons = bt[num].buttons_mask = LL_GPIO_IsInputPinSet(bt[num].GPIOx,bt[num].button_pin); //bt[0].GPIOx->IDR & bt[0].button_pin;
