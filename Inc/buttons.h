...
#define long_press_start_LEFT_TOP			long_press_start_Msk2
#define long_press_start_RIGHT_TOP		long_press_start_Msk3
#define long_press_start_LEFT_BOTTOM	long_press_start_Msk4
#define long_press_start_RIGHT_BOTTOM	long_press_start_Msk5
...
#define long_press_end_LEFT_TOP			long_press_end_Msk2
#define long_press_end_RIGHT_TOP		long_press_end_Msk3
#define long_press_end_LEFT_BOTTOM	long_press_end_Msk4
#define long_press_end_RIGHT_BOTTOM	long_press_end_Msk5
